...
<head>
    ...
    <title>CS WaitList</title>
    <link rel="stylesheet" href="assets/faq_style.css">
    <!-- font Family -->
    ...
    <!-- <div class="container"> -->
     <div class="modal fade" id="registerModal" tabindex="-1" role="dialog"
        ...
        <div class="container-class">
            ...
            <div class="logi">
               <a href='/waitlist'> <img src="assets/w-icon/connectskillz 1.svg" alt=""></a>
            ...
            <div class="container-vision">
                <div class="cont-vision">
                    <div class="cont-success">
                        ...
                        <div class="img-group">
                            <img src="assets/images/RETRO.svg" alt="">
                        </div>
    ...
    <div class="cased">
        <section class="spec">
            ...
            <div class="sp-sec">
                <div class="specs">
                    <div class="specicon">
                        <img src="assets/Indicon/Trainer.svg" alt="" >
                    </div>
                    <div class="spc-txt">
                        <h3>Best Trainers</h3>
                        <p>Our best trainers will help you get the best shape to achieve your dreams</p>
                    </div>
                </div>
                ...
                <div class="specs">
                    <div class="specicon">
                     <img src="assets/Indicon/flexit.svg" alt="">
                    </div>
                    <div class="spc-txt">
                        <h3>Flexible</h3>
                        <p>Our flexible platform will give you the freedom to create and choose matters irrespective of what your goals are, we provide various special features just for you</p>
                    </div>
                </div>
                ...
                <!-- 03 --> <div class="specs">
                    ...
                    <div class="spc-txt">
                        <h3>Easy Access</h3>
                        <p>Not only is the website easy to use and navigate, we provide you with various special features to make your experience even better</p>
                    </div>
                </div>
                ...
                <div class="specs">
                    <div class="specicon">
                        <img src="assets/Indicon/livep.svg" alt="" >
                    </div>
                    <div class="spc-txt">
                        <h3>Live Projects</h3>
                        <p>Make the most of your learning experience with our Live Projects,Research Projects and Case studies that have been carefully curated by our team of industry experts</p>
                    </div>
                </div>
                ...
                <div class="specs">
                    <div class="specicon">
                        <img src="assets/Indicon/mento.svg" alt="" >
                    </div>
                    <div class="spc-txt">
                        <h3>Personal Mentors</h3>
                        <p>Achieve your goals faster than you think with the help of our Expert Mentors</p>
                    </div>
                </div>
            </div>
        ...
        $.ajax({
            ...
            error: function(data) {
               // console.log(data,data.responseJSON)
                ...
                Swal.fire('Opps!', data.responseJSON.errors.email[0], 'error')
                }
                  else {
                    Swal.fire('Opps!', 'An error occured, please try again later', 'error')
                  }
            }
        })
