            ...
            <tbody>
                    ...
                    <td style='text-align:center'>
                        <div
                            ...
                            <div style="padding-bottom: 30px; font-size: 17px;">
                                <strong>Thanks for joining our waiting list!</strong>
                            </div>
                            <div style="padding-bottom: 30px">
                                Hi {{ ucfirst($name) }},<br><br>
                              	We are so thrilled you’ve decided to join CS Waiting List. Hats off on making an excellent decision. You are one step closer to your success story. 
                              <br><br>
                                To proceed, kindly click on the verify button below to verify your email address with us.<br><br>
                ...
                <tr>
                    <td 
                        ...
                        <p>United Kingdom.</p>
                        <p>Copyright ©
                            <a href="https://connectinskillz.org" rel="noopener" target="_blank">Connectinskillz.org</a>.
                        </p>
                    </td>
                </tr>
    </div>
